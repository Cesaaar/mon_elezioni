...
$(function() {
  ...
  // Chart setup
  function monthlySalesArea(element, height, color, json) {
  ...
  // ------------------------------
  // '/trend_fb_fans1'
  // 'static/assets/demo_data/dashboard/monthly_sales.json'
  ...
  d3.json(json, function (error, data) {
          ...
          focusText.select("text").attr('text-anchor', 'end').attr("x", function () { return (x(d.date) - 15) + "px" }).text(formatDate(d.date) + " - " + d.value + " fans");
          }
          else {
          focusText.select("text").attr('text-anchor', 'start').attr("x", function () { return (x(d.date) + 15) + "px" }).text(formatDate(d.date) + " - " + d.value + " fans");
          }
          }
